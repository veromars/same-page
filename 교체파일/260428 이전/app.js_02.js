      ...
      <div class="match-intro-modal fade-in">
        ...
        <div class="match-intro-pm">
          ...
          <div class="match-options fade-in" id="regular-match-options" style="animation-delay: 1s; display: flex; flex-direction: column; margin-bottom: 12px; margin-top: 16px; gap: 8px; padding: 0 4px;">
            <button class="match-option-btn" onclick="closeAnswerCard(); switchTab('meetups');" style="display:block; width:100%; padding:16px 20px; border-radius:14px; border:1.5px solid #C89FDB; background:white; color:#9B72CC; font-size:15px; font-family:'Pretendard',sans-serif; font-weight:500; text-align:center; cursor:pointer; box-shadow:0 1px 4px rgba(0,0,0,0.06);">
              📅 함께 참여할 수 있는 모임이 있어요
            </button>
            <button class="match-option-btn" onclick="document.getElementById('match-intro-input-field').value = '✨ 둘만의 만남을 제안해볼까요?'; document.getElementById('match-intro-input-field').focus();" style="display:block; width:100%; padding:16px 20px; border-radius:14px; border:1.5px solid #C89FDB; background:white; color:#9B72CC; font-size:15px; font-family:'Pretendard',sans-serif; font-weight:500; text-align:center; cursor:pointer; box-shadow:0 1px 4px rgba(0,0,0,0.06);">
              ✨ 둘만의 만남을 제안해볼까요?
            </button>
