...
window.openAnswerRevealModal = function (profileId, qId) {
  ...
  const renderPage = (pageIdx) => {
    ...
    amc.innerHTML = `
      <div id="nb-modal" class="book-page-modal" style="--chap-edge-grad: ${bgGradient}; touch-action: pan-y;">
        <!-- Header -->
